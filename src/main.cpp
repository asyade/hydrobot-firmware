...
#define BRONCHUS_FILL_DURATION              21000
#define BRONCHUS_EMPTY_DURATION             20000
...
unsigned int status = S_BREATHING | S_OSMOS_SWITCH_CLOSING | S_BRONCHUS_STANDBY_SAMPLING;
